...
export default function AddAddress({ navigation, route: { params } }) {
  const {
    ///for edit
    edit,
    fromPath = "",
  ...
  const validationCheck = () => {
    ...
    if (!validate_name(uName))
      ...
      return (validationErrorMessage = "Invalid/Empty Mobile Number");
    else if (!validate_PIN(uPincode))
      return (validationErrorMessage = "Invalid/Empty PinCode");
    else if (!validate_address(uFlat))
      return (validationErrorMessage =
        "Empty Flat, House no, Building, Company, Apartment");
    else if (!validate_name(uArea))
      return (validationErrorMessage = "Empty Area, Street, Sector, Village");
    else if (!validate_name(uCity))
      return (validationErrorMessage = "Empty City");
    else if (!validate_name(uState))
      return (validationErrorMessage = "Empty Area, Street, Sector, Village");
