...
import { CHANGEPASSWORDNEW_URL, FORGOTPASSWORD_URL, SETTING_URL } from "../../Utils/ApiUrlConstants";
...
export default function NewPassword({ navigation,route }) {
  ...
  const resetPasswordUrl = CHANGEPASSWORDNEW_URL;
  ...
  const validationHandler = () => {
    ...
    if (valMsg) {
      ...
      setLoader(true);
      fetchUrl(resetPasswordParams, token, resetPasswordUrl)
        .then((resJson) => {
          ////////////////////
          setLoader(false);
